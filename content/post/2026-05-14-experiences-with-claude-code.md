+++
title = "Experiences with Claude Code"
description = "Claude Code does not make a PM an Engineer"
date = "2026-01-14"
tags = ["Claude", "PM"]
draft = false
+++
...
## Enter Claude Code
At work we've just released a new CLI, neo4j-cli ( Go look at [neo4j.sh](https://neo4j.sh) to learn more.  It's worth it )  This is a CLI that was not only built to work for people and AI, it was also ( mostly ) written by AI. 
