...
draft = true
title = 'A guide to using the new, Go based, Aura CLI'
+++
...
2. Navigate to the top right where your account name is displayed as shown in the red box below and click on the down arrow
   ...
   ![](/../images/guide-to-new-aura-cli/console-classic-home.png)
...
4. From the Account Details display, select the _Create_ button in the Aura API Credentials section.
   ...
   ![](/../images/guide-to-new-aura-cli/console-classic-api-keys.png)
...
2. Navigate to the top right where your account name is displayed as shown in the red box below and click on the down arrow
   ...
   ![](/../images/guide-to-new-aura-cli/unified-console-home.png)

3. From the menu, choose \_API keys\_\_

   ![](/../images/guide-to-new-aura-cli/unified-console-account-dropdown.png)

4. When API Keeys is shown, select _Create_

   ![](/../images/guide-to-new-aura-cli/unified-console-api-keys.png)

5. On the pop-up window, enter a name for the API Key and then select _Create_

   ![](/../images/guide-to-new-aura-cli/unified-console-create-api-key.png)
